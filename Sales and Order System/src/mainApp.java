...
public class mainApp extends JFrame implements ActionListener {
    ...
    public mainApp() {
        ...
        myproducts.loadFile("./data/ProductsList.txt");

        //Loading the text file that contains the orders.
        myorders.loadFile("./data/OrdersList.txt", myproducts);

        //Loading the text file that contains the sales.
        mysales.loadFile("./data/SalesList.txt", myproducts);
        ...
        if (e.getSource() == j1) {
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                if (selectedFile.getName().equals("ProductsList.txt")) {
                    ...
                    final CardLayout cardLayout = (CardLayout) products_panel.getLayout();
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    ...
                                    but8.addActionListener(new ActionListener() {
                                        public void actionPerformed(ActionEvent e) {
                                            ...
                                            final String s = myproducts.Products.get(u).getProductName();
                    ...
                    for (int i = 0; i < orders_buttons.size(); i++) {
                        final int num = i;
                        final int co = orders_code.get(i);
            ...
            final JFrame frame20 = new JFrame("Options");
            ...
            final JFrame frame30 = new JFrame("Options");
