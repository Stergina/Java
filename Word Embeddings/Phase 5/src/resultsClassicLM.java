...
public class resultsClassicLM
{
	public static void main(String[] args) throws IOException, ParseException 
	{
		...
		Similarity[] sims = {new ClassicSimilarity(),new LMJelinekMercerSimilarity((float) 0.7)}; 
		...
		for (int k = 0; k < topk.length; k++)
		{
			...
			String fileName = "results" + topk[k] + "_ClassicLM.txt";
